...
select * from (
  ...
  from (values
    ...
    ('edit_card_payment_leg',  'card.sql'),
    ('edit_installment_payment', 'card.sql'),
    ('edit_card_statement_payment', 'card.sql'),
    ('edit_debt_payment',      'debt.sql'),
    ('edit_pending_payment',   'wallet.sql'),
    ('edit_recurring_payment', 'recurring.sql'),
